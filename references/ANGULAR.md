...
To support Angular Router with HTML5 history mode, create a controller that forwards all non-API requests to index.html:
...
public class SpaController {
    ...
    /**
     * Forward all routes to index.html to support Angular Router HTML5 history mode.
...
This controller ensures that refreshing the browser on any Angular route (e.g., `/items/123`) serves the index.html file, allowing Angular Router to handle the routing.
